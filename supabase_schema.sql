...
-- ==================== ÍNDICES ====================
CREATE INDEX IF NOT EXISTS idx_clients_lawyer ON clients(lawyer_id);
CREATE INDEX IF NOT EXISTS idx_processes_lawyer ON processes(lawyer_id);
...
-- Políticas de acesso (permitir tudo por enquanto - você pode restringir depois)
CREATE POLICY "Allow all for lawyers" ON lawyers FOR ALL USING (true);
CREATE POLICY "Allow all for clients" ON clients FOR ALL USING (true);
CREATE POLICY "Allow all for processes" ON processes FOR ALL USING (true);
...
CREATE POLICY "Allow all for contracts" ON contracts FOR ALL USING (true);
...
CREATE POLICY "Allow all for publications" ON publications FOR ALL USING (true);
